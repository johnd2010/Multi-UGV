...
if("TRUE" STREQUAL "TRUE")
  set(core_msgs_SOURCE_PREFIX /home/irsg/Multi-UGV/src/common_nebula_slam/core_msgs)
  set(core_msgs_DEVEL_PREFIX /home/irsg/Multi-UGV/devel/.private/core_msgs)
  ...
  set(core_msgs_INSTALL_PREFIX /home/irsg/Multi-UGV/install)
...
if(NOT "/home/irsg/Multi-UGV/devel/.private/core_msgs/include " STREQUAL " ")
  set(core_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/irsg/Multi-UGV/devel/.private/core_msgs/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Brett Lopez <btlopez@mit.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'core_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/irsg/Multi-UGV/src/common_nebula_slam/core_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/irsg/Multi-UGV/devel/.private/core_msgs/lib;/home/irsg/Multi-UGV/devel/lib;/home/irsg/workspace/devel/lib;/home/irsg/mrs_workspace/devel/lib;/opt/ros/noetic/lib)
...
set(depends "diagnostic_msgs;std_msgs;geometry_msgs;sensor_msgs;message_runtime")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(core_msgs_EXPORTED_TARGETS ${${core_msgs_dep}_EXPORTED_TARGETS})
endforeach()
