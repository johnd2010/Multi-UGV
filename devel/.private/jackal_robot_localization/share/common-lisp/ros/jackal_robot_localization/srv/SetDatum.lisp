...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<SetDatum-request> is deprecated: use jackal_robot_localization-srv:SetDatum-request instead.")))

(cl:ensure-generic-function 'geo_pose-val :lambda-list '(m))
(cl:defmethod geo_pose-val ((m <SetDatum-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:geo_pose-val is deprecated.  Use jackal_robot_localization-srv:geo_pose instead.")
  (geo_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-request>)))
  ...
  "jackal_robot_localization/SetDatumRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-request)))
  "Returns string type for a service object of type 'SetDatum-request"
  "jackal_robot_localization/SetDatumRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetDatum-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDatum-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<SetDatum-response> is deprecated: use jackal_robot_localization-srv:SetDatum-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDatum-response>)))
  ...
  "jackal_robot_localization/SetDatumResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum-response)))
  "Returns string type for a service object of type 'SetDatum-response"
  "jackal_robot_localization/SetDatumResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDatum)))
  ...
  "jackal_robot_localization/SetDatum")