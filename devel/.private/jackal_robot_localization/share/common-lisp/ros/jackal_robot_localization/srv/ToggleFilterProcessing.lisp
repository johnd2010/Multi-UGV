...
(cl:defmethod cl:initialize-instance :after ((m <ToggleFilterProcessing-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ToggleFilterProcessing-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<ToggleFilterProcessing-request> is deprecated: use jackal_robot_localization-srv:ToggleFilterProcessing-request instead.")))

(cl:ensure-generic-function 'on-val :lambda-list '(m))
(cl:defmethod on-val ((m <ToggleFilterProcessing-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:on-val is deprecated.  Use jackal_robot_localization-srv:on instead.")
  (on m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ToggleFilterProcessing-request>)))
  ...
  "jackal_robot_localization/ToggleFilterProcessingRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ToggleFilterProcessing-request)))
  "Returns string type for a service object of type 'ToggleFilterProcessing-request"
  "jackal_robot_localization/ToggleFilterProcessingRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ToggleFilterProcessing-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ToggleFilterProcessing-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<ToggleFilterProcessing-response> is deprecated: use jackal_robot_localization-srv:ToggleFilterProcessing-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <ToggleFilterProcessing-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:status-val is deprecated.  Use jackal_robot_localization-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ToggleFilterProcessing-response>)))
  ...
  "jackal_robot_localization/ToggleFilterProcessingResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ToggleFilterProcessing-response)))
  "Returns string type for a service object of type 'ToggleFilterProcessing-response"
  "jackal_robot_localization/ToggleFilterProcessingResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ToggleFilterProcessing)))
  ...
  "jackal_robot_localization/ToggleFilterProcessing")