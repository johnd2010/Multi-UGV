...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<SetPose-request> is deprecated: use jackal_robot_localization-srv:SetPose-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <SetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:pose-val is deprecated.  Use jackal_robot_localization-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPose-request>)))
  ...
  "jackal_robot_localization/SetPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPose-request)))
  "Returns string type for a service object of type 'SetPose-request"
  "jackal_robot_localization/SetPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<SetPose-response> is deprecated: use jackal_robot_localization-srv:SetPose-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPose-response>)))
  ...
  "jackal_robot_localization/SetPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPose-response)))
  "Returns string type for a service object of type 'SetPose-response"
  "jackal_robot_localization/SetPoseResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPose)))
  ...
  "jackal_robot_localization/SetPose")