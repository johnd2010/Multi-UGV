...
(cl:defmethod cl:initialize-instance :after ((m <GetState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<GetState-request> is deprecated: use jackal_robot_localization-srv:GetState-request instead.")))

(cl:ensure-generic-function 'time_stamp-val :lambda-list '(m))
(cl:defmethod time_stamp-val ((m <GetState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:time_stamp-val is deprecated.  Use jackal_robot_localization-srv:time_stamp instead.")
  (time_stamp m))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <GetState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:frame_id-val is deprecated.  Use jackal_robot_localization-srv:frame_id instead.")
  (frame_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetState-request>)))
  ...
  "jackal_robot_localization/GetStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetState-request)))
  "Returns string type for a service object of type 'GetState-request"
  "jackal_robot_localization/GetStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jackal_robot_localization-srv:<GetState-response> is deprecated: use jackal_robot_localization-srv:GetState-response instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <GetState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:state-val is deprecated.  Use jackal_robot_localization-srv:state instead.")
  (state m))

(cl:ensure-generic-function 'covariance-val :lambda-list '(m))
(cl:defmethod covariance-val ((m <GetState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jackal_robot_localization-srv:covariance-val is deprecated.  Use jackal_robot_localization-srv:covariance instead.")
  (covariance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetState-response>)))
  ...
  "jackal_robot_localization/GetStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetState-response)))
  "Returns string type for a service object of type 'GetState-response"
  "jackal_robot_localization/GetStateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetState)))
  ...
  "jackal_robot_localization/GetState")