...
project = u'jackal_robot_localization'
...
latex_documents = [
    (master_doc, 'jackal_robot_localization.tex', u'robot\\_localization Documentation',
     u'Tom Moore', 'manual'),
]
...
man_pages = [
    (master_doc, 'jackal_robot_localization', u'jackal_robot_localization Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jackal_robot_localization', u'jackal_robot_localization Documentation',
     author, 'jackal_robot_localization', 'One line description of project.',
     'Miscellaneous'),
]
